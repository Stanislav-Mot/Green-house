...
export class ProductsService {
 ...
 create(formGroup: FormGroup) {
  ...
  addToCart(id: number){
    return this.http.get<boolean>(`${PATH_BACKEND_API}/products/${id}/cart`);
  }

  addToFavorite(id: number){
    return this.http.get<boolean>(`${PATH_BACKEND_API}/products/${id}/favorite`);
  }

  deleteFromCart(id: number){
    return this.http.delete<boolean>(`${PATH_BACKEND_API}/products/${id}/cart`);
  }

  deleteFromFavorite(id: number){
    return this.http.delete<boolean>(`${PATH_BACKEND_API}/products/${id}/favorite`);
  }
}
